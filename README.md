# Ariel - Program for acquiring and processing eddy current signals from PL500 device

![Ariel Image](https://zag82.ru/assets/projects/ariel.png 'Application prewiew')
